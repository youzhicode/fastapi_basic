...
class ViewConfig(Base):
    ...
    query_id: Mapped[int] = mapped_column(Integer, default=1000, nullable=False, comment="查询ID")
    version: Mapped[int] = mapped_column(Integer, default=1000, nullable=False, comment="查询版本")
